...
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOA,GPIO_Pin_1)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOA,GPIO_Pin_1)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOA,GPIO_Pin_0)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOA,GPIO_Pin_0)
