...
task_fd = kpu.load(0x2097152)
task_ld = kpu.load(0x3145728)
task_fe = kpu.load(0x4194304)

#task = kpu.load("/sd/facedetect.kmodel") #模型SD卡上
clock = time.clock() # 初始化系统时钟，计算帧率

fm.register(board_info.BOOT_KEY, fm.fpioa.GPIOHS12)#设置按键引脚
key_gpio = GPIO(GPIO.GPIOHS12, GPIO.IN)
